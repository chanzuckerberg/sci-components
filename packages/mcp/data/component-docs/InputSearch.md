...
| -------------- | --------------------------------------------------------- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| `classes`      | `object`                                                  | `{}`                                         | Class names for the internal elements: `root`, `label`, `input`, `endAdornment`, `startAdornment`, `clearButton`, and `searchButton`. |
| `disabled`     | `boolean`                                                 | `false`                                      | When set to `true`, the component becomes disabled and cannot be interacted with.                                                     |
| `handleSubmit` | `function`                                                | `function(value: string) => void`            | This function is called when the Search icon is clicked, allowing user to handle the search operation.                                |
...
| `onChange`     | `function`                                                | `function(event: React.ChangeEvent) => void` | Defines the action to be taken when the input value changes.                                                                          |
