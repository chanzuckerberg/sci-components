...
| `onSelectionChange`      | `function`                         | -                   | `(selectedIndices: number[], selectedData: StackedBarChartDataItem[]) => void`. Called with the next selection when a segment or legend item is clicked. Without it, clicking selects nothing.                           |
...
| `onSegmentClick`         | `function`                         | -                   | `(item: StackedBarChartDataItem, index: number) => void`. Fires on a segment click, alongside any selection change rather than instead of it.                                                                            |
| `onLegendItemClick`      | `function`                         | -                   | `(item: StackedBarChartDataItem, index: number) => void`. The same, for a click on a legend item.                                                                                                                        |
| `onSegmentMouseEnter`    | `function`                         | -                   | `(item: StackedBarChartDataItem, index: number) => void`. Called when the pointer enters a segment. The chart already syncs its own hover highlight between bar and legend, so this is for driving something outside it. |
| `onSegmentMouseLeave`    | `function`                         | -                   | `(item: StackedBarChartDataItem, index: number) => void`. Called when the pointer leaves a segment.                                                                                                                      |
| `onLegendItemMouseEnter` | `function`                         | -                   | `(item: StackedBarChartDataItem, index: number) => void`. Called when the pointer enters a legend item.                                                                                                                  |
| `onLegendItemMouseLeave` | `function`                         | -                   | `(item: StackedBarChartDataItem, index: number) => void`. Called when the pointer leaves a legend item.                                                                                                                  |
