...
Use Wide when pages are being displayed at a **Large** or **Medium** breakpoint (though in some cases Header Navigation – Narrow may be preferable for Medium breakpoints; see Responsive Design for more information).
...
| `isSticky`               | `boolean`                             | `true`    | When true, the navigation header sticks to the top of the page on scroll. When false, it scrolls up with the rest of the page. |
