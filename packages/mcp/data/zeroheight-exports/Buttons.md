...
The Icon Button should be used for lowest level actions that are not a part of the user's main workflow, such as closing a Dialog or expanding an Accordion (documentation coming soon).
...
Used to complete primary actions within Forms and Dropdown Menus; paired with Text Inputs.
...
Used to complete secondary actions within Forms and Dropdown Menus; paired with Text Inputs.
...
If a longer or inline call to action with a similar visual style is needed, a Text Link might be more appropriate. In addition to containing more words, Text Links navigate the user away from their current page to a new one, whereas Minimal Buttons keep users on the same page.
...
Icon Buttons can be coupled with a Dropdown Menu when there are multiple options available to the user upon triggering the Button.
...
The Tertiary Icon Button should be used for lowest level actions that are not a part of the user's main workflow, such as closing a Dialog or expanding an Accordion (documentation coming soon). It is not usually paired with other Icon Buttons.
...
The options are presented in a dropdown menu; use in conjunction with Dropdown Menu component.
...
The Secondary Square Dropdown Button should be used for deemphasized or secondary actions
...
Use Button – Square in the body or main content area of applications.
...
Minimal Buttons initiate actions that keep the user on the same page, such as opening or closing Dialogs. They should contain a maximum of 2-3 words.

If a longer or inline call to action with a similar visual style is needed, a Link might be more appropriate. In addition to containing more words, Text Links navigate the user away from their current page to a new one, whereas Minimal Buttons keep users on the same page.
...
Use when a standard Button doesn't seem necessary or won't fit such as when used as part of complex components like Tables. Button – Icon should generally be coupled with a Tooltip that is displayed on hover to provide a label indicating the Button's functionality.

Optionally, pair Button – Icon with a Tooltip to use as a label to communicate the button's functionality.
...
Use when there is a need to present the user with multiple options for actions that can be performed using a Button; the options are presented in a Dropdown Menu.
...
Alternate Dropdown Button style for use when there is a need to present the user with multiple options for actions that can be performed using a Button; the options are presented in a Dropdown Menu.
...
Use when there is a need to present the user with multiple options for actions that can be performed and a standard Dropdown Button doesn't seem necessary or won't fit such as when used as part of complex components like Tables; the options are presented in a Dropdown Menu. Dropdown Buttons should generally be coupled with a Tooltip that is displayed on hover to provide a label indicating the Button's functionality.

Optionally, pair Dropdown Button – Icon with a Tooltip to use as a label to communicate the button's functionality.
...
Use Toggle Button when there is a need to enable or disable an element in the UI (such as toggling visibility of a Panel). If users need to indicate true or false as part of a form or flip a setting or option from off to on (and vise versa), use Toggle Input.

Optionally, pair Toggle Button with a Tooltip to use as a label to communicate the button's functionality.
...
Documentation for the underlying MUI `Button` component can be found here.
