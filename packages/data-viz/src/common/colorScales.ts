...
/**
 * How values map to colors, both in a visualization and in its legend. A
 * continuous scale interpolates between its stops and renders as a gradient
 * bar; a stepped scale renders as discrete bands.
 */
 ...
 * each threshold at the bottom of the band above it: against thresholds of 0.5,
 * 0.7 and 0.9, a value of exactly 0.7 reads as the 0.7-0.9 band, not the one
 * below.
 */
