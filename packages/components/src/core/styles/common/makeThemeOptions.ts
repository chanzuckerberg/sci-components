...
export const SDSPaletteLight = (appTheme: AppTheme): SDSPalette => {
  return {
    ...
    base: {
      ...
      fillInteraction: addOpacityToHex(appTheme.colors.gray[300], 20),
      fillInteractionOnDark: addOpacityToHex(appTheme.colors.gray[300], 20),
      fillHoverInverse: addOpacityToHex(appTheme.colors.gray[300], 20),
      fillOpenInverse: addOpacityToHex(appTheme.colors.gray[300], 34),
      fillPressed: addOpacityToHex(appTheme.colors.gray[300], 30),
      fillPressedOnDark: addOpacityToHex(appTheme.colors.gray[300], 24),
...
export const SDSPaletteDark = (appTheme: AppTheme): SDSPalette => {
  return {
    ...
    base: {
      ...
      fillDisabled: appTheme.colors.gray[100],
      fillInteraction: addOpacityToHex(appTheme.colors.gray[300], 32),
      fillInteractionOnDark: addOpacityToHex(appTheme.colors.gray[300], 32),
      fillHoverInverse: addOpacityToHex(appTheme.colors.gray[300], 32),
      fillOpenInverse: addOpacityToHex(appTheme.colors.gray[300], 32),
      fillPressed: addOpacityToHex(appTheme.colors.gray[300], 40),
      fillPressedOnDark: addOpacityToHex(appTheme.colors.gray[300], 40),
