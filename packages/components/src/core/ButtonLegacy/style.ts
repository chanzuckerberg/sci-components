...
type ButtonLegacyExtraProps = ButtonLegacyProps & CommonThemeProps;

// Rounded + Square Button Styles

const ButtonStyles = (props: ButtonLegacyExtraProps): SerializedStyles => {
...
const Rounded = (props: ButtonLegacyExtraProps): SerializedStyles => {
  const corners = getCorners(props);
  return css`
...
const DestructiveButton = (props: ButtonLegacyExtraProps): SerializedStyles => {
  const { variant } = props;
...
const Minimal = (props: ButtonLegacyExtraProps): SerializedStyles => {
