import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{Aa as n,Br as r,Cn as i,Gi as a,J as o,Jr as s,Mi as c,Ni as l,Rr as u,W as d,Wr as f,Y as p,Z as m,ct as h,g,m as _,t as v}from"./iframe-Bjh1LYUt.js";import{n as y,t as b}from"./Icon-D5aq3JJF.js";import{n as x,t as S}from"./Button-BT0OC4_c.js";var C,w,T=t((()=>{l(),h(),v(),C=[`calloutTitle`,`collapsed`,`severity`,`sdsStyle`,`hideBody`],w=c(f,{shouldForwardProp:e=>!C.includes(e),target:`ez44obe0`})(g,` `,e=>{let{intent:t=`info`,sdsStyle:n,hideBody:i,collapsed:a}=e,c=m(e),l=d(e),u=o(e),f=p(e),h=f?.[t]?.ornament??`black`,g=f?.[t]?.surfaceSecondary??`white`;return`
      margin: ${c?.m}px 0;
