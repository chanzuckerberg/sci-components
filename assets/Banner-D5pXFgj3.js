import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{Aa as n,Gi as r,Mi as i,Ni as a,Y as o,Z as s,t as c,u as l}from"./iframe-Bjh1LYUt.js";import{n as u,t as d}from"./Icon-D5aq3JJF.js";import{n as f,t as p}from"./Button-BT0OC4_c.js";var m,h,g,_,v,y,b,x,S,C=t((()=>{a(),f(),c(),m=i(`div`,{target:`e15g05664`})({name:`qke47e`,styles:`flex:1 1 auto;display:flex;justify-content:center;align-items:center`}),h=[`bannerType`,`intent`],g=i(`div`,{shouldForwardProp:e=>!h.includes(e),target:`e15g05663`})(e=>{let{bannerType:t,intent:n=`info`}=e,r=s(e),i=o(e),a=t===`primary`?i?.base?.ornamentOnFill:i?.[n]?.ornament;return`
      display: flex;
      align-items: center;
    ...
    `},`;`),_=[`bannerType`,`textChild`,`intent`],v=i(p,{shouldForwardProp:e=>!_.includes(e),target:`e15g05662`})(`flex:0 0 auto;`,e=>{let{bannerType:t}=e,n=o(e);return t===`primary`?`
        svg {
  ...
  `},x=[`sdsType`,`textChild`,`intent`],S=i(`div`,{shouldForwardProp:e=>!x.includes(e),target:`e15g05660`})(l,` `,e=>{let{sdsType:t}=e,n=s(e);return`
      display: flex;
      align-items: center;
