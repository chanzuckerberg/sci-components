import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{t as n}from"./react-CK_LJ1AD.js";import{Ao as r,E as i,Eo as a,G as o,Hn as s,V as c,_a as l,da as u,gn as d,ko as f,ln as p,mn as m,pa as h,pn as g,ti as _,xa as v}from"./iframe-VwaeVae3.js";import{n as y,t as b}from"./Icon-8IjK39Dx.js";import{n as x,t as S}from"./Button-Ces7mL1b.js";var C,w,T=e((()=>{r(),s(),i(),C=[`calloutTitle`,`collapsed`,`severity`,`sdsStyle`,`hideBody`],w=f(l,{shouldForwardProp:e=>!C.includes(e),target:`ez44obe0`})(o,` `,e=>{let{intent:t=`info`,sdsStyle:n,hideBody:r,collapsed:i}=e,a=d(e),o=p(e),s=g(e),c=m(e),l=c?.[t]?.ornament??`black`,u=c?.[t]?.surfaceSecondary??`white`;return`
      margin: ${a?.m}px 0;
