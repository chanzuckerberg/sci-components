import{i as e}from"./preload-helper-xPQekRTU.js";import{Fi as t}from"./iframe-DocVhSSI.js";import{n,t as r}from"./Icon-CQ-y6cAL.js";import{a as i,n as a}from"./utils-BxIa431Z.js";import{n as o,t as s}from"./Callout-C9pGampS.js";import{i as c,r as l}from"./Button-CfkvkcRt.js";import{a as u,i as d,n as f,r as p,t as m}from"./constants-L7OV6GKh2.js";import{n as h,t as g}from"./ButtonDropdown-CRCw6Q-0.js";var _,v,y,b=e((()=>{c(),h(),o(),_=t(),v=(0,_.jsx)(s,{intent:`negative`,title:`Invalid Props!`,body:(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(`strong`,{children:`ButtonDropdown`}),` does not support the`,` `,(0,_.jsx)(`strong`,{children:`destructive`}),` type. Please choose either`,` `,(0,_.jsx)(`strong`,{children:`primary`}),` or `,(0,_.jsx)(`strong`,{children:`secondary`}),`.`]})}),y=e=>{let{backgroundAppearance:t,sdsStyle:n,startIcon:r,sdsType:i,...a}=e;return i===`destructive`?v:(0,_.jsx)(l,{backgroundAppearance:e.backgroundAppearance,children:(0,_.jsx)(g,{backgroundAppearance:t,startIcon:r,sdsStyle:n,sdsType:i,...a})})}})),x,S,C,w,T;e((()=>{n(),u(),b(),i(),x=t(),S={argTypes:{backgroundAppearance:{control:{type:a},options:[`matchBackground`,`dark`]},backgroundOnHover:{control:{type:`boolean`}},children:{control:{type:`text`}},disabled:{control:{type:`boolean`}},startIcon:{control:{labels:p,type:`select`},mapping:d,options:Object.keys(d)},size:{control:{type:a},options:[`small`,`medium`,`large`]},sdsStyle:{control:{type:a},options:[`solid`,`outline`,`minimal`],required:!0},sdsType:{control:{type:a},options:[`primary`,`secondary`],required:!0}},component:y,title:`Components/Buttons/ButtonDropdown`},C={args:{backgroundAppearance:`matchBackground`,backgroundOnHover:!0,children:`Label`,disabled:!1,startIcon:d[0],onClick:m.onClick,size:`large`,sdsStyle:`solid`,sdsType:`primary`}},w={args:{backgroundAppearance:`matchBackground`,disabled:!1,startIcon:(0,x.jsx)(r,{sdsIcon:`Download`,sdsSize:`s`}),onClick:m.onClick,sdsStyle:`solid`,size:`large`,sdsType:`primary`},parameters:{controls:{exclude:f},snapshot:{skip:!0}},render:e=>(0,x.jsx)(y,{...e,"aria-label":`button-dropdown`,"data-testid":`button-dropdown`})},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
