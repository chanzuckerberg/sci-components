import{c as e,i as t}from"./preload-helper-DbRxMUml.js";import{F as n,Gn as r,Kr as i,O as a,W as o,Xn as s,Y as c,Z as l,Zn as u,cr as d,q as f,st as p}from"./iframe-DI6qETgL.js";import{t as m}from"./Button-K7qsdWHe.js";import{t as h}from"./Tooltip-C5txiU7R.js";import{t as g}from"./TooltipTable-Bwr86nVx.js";import{t as _}from"./TagFilter-CRB6ZqZi.js";import{r as ee,t as te}from"./discreteColorGenerator-BUpitvxW.js";import{t as v}from"./src-qnNA-mro.js";var ne,re,ie,ae,oe,se,ce,y=t((()=>{u(),v(),ne=s(`div`,{target:`eja2e936`})(`display:flex;flex-direction:column;width:`,e=>typeof e.width==`number`?`${e.width}px`:e.width,`;`),re=s(`div`,{target:`eja2e935`})(`display:flex;align-items:center;`,e=>{let t=l(e);return`
      gap: ${t?.s}px;
      margin-bottom: ${t?.l}px;
    `},`;`),ie=s(`div`,{target:`eja2e934`})(a,` `,e=>`
      color: ${c(e)?.base?.textPrimary};
    `,`;`),ae=s(`div`,{target:`eja2e933`})(n,` `,e=>{let t=l(e),n=o(e),r=c(e);return`
      padding: ${t?.xxxs}px ${t?.xxs}px;
      border-radius: ${n?.m}px;
      background-color: ${r?.base?.backgroundTertiary};
      color: ${r?.base?.textSecondary};
    `},`;`),oe=s(`div`,{target:`eja2e932`})(e=>{let{width:t,barHeight:n,isEmpty:r}=e,i=o(e),a=c(e),s=typeof t==`number`?`${t}px`:t;return`
      display: flex;
      ...
      overflow: hidden;
    `},`;`),se=s(`div`,{target:`eja2e931`})(e=>{let{color:t,height:n,percentage:r,opacity:i,disabled:a,isLast:o}=e,s=l(e)?.xxxs||0;return`
      background-color: ${t};
      height: ${n}px;
      flex-grow: ${r};
      flex-basis: 0;
