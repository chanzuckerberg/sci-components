...
<p>
  Selection is controlled. Clicking a residue calls
  <code>onResidueClick</code>; echoing that index back through
  <code>selectedResidue</code> zooms the camera in on it, and setting it to
  <code>null</code> zooms back out. Clicking empty space fires
  <code>onSelectionClear</code>.
</p>
<p>
...
<table class="sds-doc-table">
  ...
  <tr>
    ...
    <td>
      <p>
        0-based index of the selected residue. Controlled: setting it zooms the
        camera in on that residue, and clearing it zooms back out.
      </p>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      <p>
        <code>(residueIndex: number, compId: string) =&gt; void</code>. Called
        with the 0-based residue index and 3-letter amino acid code when a
        residue is clicked.
      </p>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <p>
        <code
          >(residueIndex: number | null, compId: string | null) =&gt; void</code
        >. Called as the pointer moves over residues, and with
        <code>(null, null)</code> when it leaves the structure.
      </p>
    </td>
  </tr>
  <tr>
    <td>
      <p><code>onSelectionClear</code></p>
    </td>
    <td>
      <p><code>function</code></p>
    </td>
    ...
    <td>
      <p>
        <code>() =&gt; void</code>. Called when the user clicks empty space,
...
<table class="sds-doc-table">
  ...
  <tr>
    ...
    <td><p>-</p></td>
    <td><p>Help tooltip attached to the legend caption.</p></td>
  </tr>
  <tr>
    <td>
