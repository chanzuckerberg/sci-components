import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{Aa as n,F as r,Gi as i,Mi as a,Ni as o,O as s,Ti as c,W as l,Y as u,Z as d,ct as f,q as ee}from"./iframe-ZT52KRhI.js";import{t as p}from"./Button-DpLCbr9e.js";import{t as m}from"./Tooltip-DWKWoQjd.js";import{t as h}from"./TooltipTable-BprlFyxr.js";import{t as g}from"./TagFilter-CXapVDyj.js";import{r as te,t as ne}from"./discreteColorGenerator-Cq7CkgR-.js";import{t as _}from"./src-CLb-2CWf.js";var re,ie,ae,oe,se,ce,le,v=t((()=>{o(),_(),re=a(`div`,{target:`eja2e936`})(`display:flex;flex-direction:column;width:`,e=>typeof e.width==`number`?`${e.width}px`:e.width,`;`),ie=a(`div`,{target:`eja2e935`})(`display:flex;align-items:center;`,e=>{let t=d(e);return`
      gap: ${t?.s}px;
      margin-bottom: ${t?.l}px;
    `},`;`),ae=a(`div`,{target:`eja2e934`})(s,` `,e=>`
      color: ${u(e)?.base?.textPrimary};
    `,`;`),oe=a(`div`,{target:`eja2e933`})(r,` `,e=>{let t=d(e),n=l(e),r=u(e);return`
      padding: ${t?.xxxs}px ${t?.xxs}px;
      border-radius: ${n?.m}px;
      background-color: ${r?.base?.backgroundTertiary};
      color: ${r?.base?.textSecondary};
    `},`;`),se=a(`div`,{target:`eja2e932`})(e=>{let{width:t,barHeight:n,isEmpty:r}=e,i=l(e),a=u(e),o=typeof t==`number`?`${t}px`:t;return`
      display: flex;
      ...
      overflow: hidden;
    `},`;`),ce=a(`div`,{target:`eja2e931`})(e=>{let{color:t,height:n,percentage:r,opacity:i,disabled:a,isLast:o}=e,s=d(e)?.xxxs||0;return`
      background-color: ${t};
      height: ${n}px;
      flex-grow: ${r};
      flex-basis: 0;
