import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{t as n}from"./react-CK_LJ1AD.js";import{Ao as r,E as i,Eo as a,U as o,gn as s,ko as c,mn as l}from"./iframe-BwqAVhEM.js";import{n as u,t as d}from"./Icon-Dl03WEAu.js";var f,p,m=e((()=>{r(),i(),f=c(`div`,{target:`em85jr71`})(`display:flex;flex-direction:column;`,e=>{let t=s(e),n=l(e),r=e.borderIntent?n?.[e.borderIntent]?.border:`transparent`;return`
      gap: ${t?.s}px;
      position: relative;
