import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{Fi as n,Ii as r,Li as i,Qa as a,Y as o,Z as s,h as c,t as l}from"./iframe-DocVhSSI.js";import{n as u,t as d}from"./Icon-CQ-y6cAL.js";var f,p,m=e((()=>{i(),l(),f=r(`div`,{target:`em85jr71`})(`display:flex;flex-direction:column;`,e=>{let t=s(e),n=o(e),r=e.borderIntent?n?.[e.borderIntent]?.border:`transparent`;return`
      gap: ${t?.s}px;
      position: relative;
    ...
    `},`;`),p=r(`div`,{target:`em85jr70`})(c,` display:flex;align-items:start;`,e=>{let t=s(e),n=o(e)?.[e.intent];return`
      gap: ${t?.xs}px;
      color: ${n?.foreground};
