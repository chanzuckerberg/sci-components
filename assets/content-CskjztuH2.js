...
<p>
  ...
  <code>onResidueClick</code> with a <code>ResidueRef</code>; echoing its
  <code>index</code> back through <code>selectedResidue</code> zooms the camera
  in on it, and setting it to <code>null</code> zooms back out. Clicking empty
  space fires <code>onSelectionClear</code>.
</p>
<p>
...
<table class="sds-doc-table">
  ...
  <tr>
    ...
    <td>
      <p>
        <code>(residue: ResidueRef) =&gt; void</code>. Called with the clicked
        residue: <code>index</code> (0-based, across the whole structure, and
        what <code>selectedResidue</code> takes), <code>compId</code>,
        <code>chainId</code>, <code>seqId</code> and <code>insCode</code>.
      </p>
    </td>
  </tr>
  <tr>
