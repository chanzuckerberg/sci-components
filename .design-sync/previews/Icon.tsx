...
const ICON_SIZES: Record<string, string> = {
  ...
  Edit: "s",
  Envelope: "s",
  ExclamationMarkCircle: "s",
  ExclamationMarkSpeechBubble: "l",
  EyeClosed: "s",
  EyeOpen: "s",
  Filter: "s",
  FlagCheck: "s",
  ...
  Sparkles: "s",
  SpeechBubbles: "l",
  SquareOnDashedSquare: "l",
  SquareOnSquareArrowDownRight: "s",
  Starburst: "s",
  Star: "l",
  Table: "s",
  ThumbsDown: "s",
  ...
  TreeDendogram: "l",
  TreeHorizontal: "s",
  TreeHorizontalPrivate: "l",
  TreeHorizontalPublic: "l",
  TreeHorizontalTopRightFilled: "l",
  TreeVertical: "s",
  TriangleDown: "s",
  TriangleLeft: "s",
  TriangleRight: "s",
  ...
  return (
    ...
    >
      {ICON_NAMES.map((name) => (
        ...
        >
          <RawIcon
            sdsIcon={name as never}
            sdsSize={ICON_SIZES[name] as never}
            color="gray"
            shade={500 as never}
          />
          <span
